    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          ...
          <p className="text-gray-400 mt-1">View and manage your tracked time</p>
        </div>
        ...
        <div className="bg-gray-800 rounded-xl p-6 border border-gray-700">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-bold text-white">{categoryTotals.length}</p>
            </div>
      ...
      <div className="bg-gray-800 rounded-xl p-6 border border-gray-700">
        ...
        {activities.length === 0 ? (
          <div className="text-center py-12">
            ...
            <p className="text-gray-400 text-lg mb-4">No activities found for this date</p>
            <p className="text-gray-500">Start tracking your time to see your history here!</p>
          </div>
        ) : (
                ...
                <div className="flex items-center space-x-4 flex-1">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-xs text-gray-500 mt-1">
                      Added at {new Date(activity.createdAt).toLocaleTimeString([], {
                        hour: '2-digit',
                        minute: '2-digit'
                      })}
                    </p>
